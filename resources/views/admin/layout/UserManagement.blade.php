                    ...
                    <div class="card-body">
                      ...
                      <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg">
                          ...
                          <!-- /.direct-chat-info -->
                          <img class="direct-chat-img" src="Admin_Theme/dist/img/user1-128x128.jpg" alt="message user image">
                          <!-- /.direct-chat-img -->
                        ...
                        <div class="direct-chat-msg right">
                          ...
                          <!-- /.direct-chat-info -->
                          <img class="direct-chat-img" src="Admin_Theme/dist/img/user3-128x128.jpg" alt="message user image">
                          <!-- /.direct-chat-img -->
                          <div class="direct-chat-text">
                            بهتره اینو باور کنی :)
                          </div>
                      ...
                      <div class="direct-chat-contacts">
                        <ul class="contacts-list">
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user1-128x128.jpg">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user7-128x128.jpg">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user3-128x128.jpg">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user5-128x128.jpg">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user6-128x128.jpg">
                          ...
                          <li>
                            <a href="#">
                              <img class="contacts-list-img" src="Admin_Theme/dist/img/user8-128x128.jpg">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body p-0">
                      <ul class="users-list clearfix">
                        <li>
                          <img src="Admin_Theme/dist/img/user1-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">حسام موسوی</a>
                          <span class="users-list-date">امروز</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user8-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">ایمان</a>
                          <span class="users-list-date">دیروز</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user7-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">فاطمه</a>
                          <span class="users-list-date">۱۷ اسفند</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user6-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">جان</a>
                          <span class="users-list-date">۱۴ اسفند</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user2-160x160.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">محمد</a>
                          <span class="users-list-date">۱۲ دی</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user5-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">سارا</a>
                          <span class="users-list-date">۱۲ دی</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user4-128x128.jpg" alt="User Image">
                          <a class="users-list-name mt-2" href="#">مریم</a>
                          <span class="users-list-date">۱۲ دی</span>
                        </li>
                        <li>
                          <img src="Admin_Theme/dist/img/user3-128x128.jpg" alt="User Image">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table m-0">
                      ...
                      <tr>
                        <td><a href="Admin_Theme/pages/examples/invoice.html">OR1848</a></td>
                      ...
                      <tr>
                        <td><a href="Admin_Theme/pages/examples/invoice.html">OR7429</a></td>
                        <td>آیفون X max</td>
                      ...
                      <tr>
                        <td><a href="Admin_Theme/pages/examples/invoice.html">OR9842</a></td>
                        <td>بازی ندای وظیفه ۱۰</td>
                        <td><span class="badge badge-success">ارسال شده</span></td>
                        <td>
                          <div class="sparkbar" data-color="#00a65a" data-height="20">90,80,90,-70,61,-83,63</div>
                  ...
                  <ul class="products-list product-list-in-card pl-2 pr-2">
                    <li class="item">
                      <div class="product-img">
                        <img src="Admin_Theme/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                      </div>
